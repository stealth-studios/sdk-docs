<script setup lang="ts">
	...
	const externalComputed = computed(
...
<template>
	<component
		...
		:target="props.target ?? (externalComputed ? '_blank' : undefined)"
		:rel="props.rel ?? (externalComputed ? 'noreferrer' : undefined)"
	>
		<VPImage v-if="icon" height="16" width="16" :image="icon" />
		<p>
			{{ text }}
		</p>
	</component>
